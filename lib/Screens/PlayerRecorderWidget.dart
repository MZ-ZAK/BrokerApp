...
class PlayerRecorderWidget extends StatefulWidget {
  @override
  _PlayerRecorderWidgetState createState() => _PlayerRecorderWidgetState();
}

class _PlayerRecorderWidgetState extends State<PlayerRecorderWidget> {
  //Player
  ...
  Future _initSettings() async {
    ...
    if (AppConstants().selectedContact.VOICELINK != "" && AppConstants().selectedContact.VOICELINK != "[]") {
      ...
      for (int i1 = 0; i1 < AppConstants.newVoiceLink.length; i1++) {
        ...
        audios.add(Audio.liveStream(AppConstants.websiteURL + "AudioFiles/" + AppConstants().selectedContact.OWNERID.toString() + "/contact/" + AppConstants.newVoiceLink[i1].toString() + ".aac"));
        ...
        AppConstants.newVoiceLink.length > 0 && AppConstants().listenToConnectivity().keys.toList()[0] != ConnectivityResult.none
            ? Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                GFButton(
                    ...
                    textColor: AppConstants.grey,
                    child: Text(playButtonTextPlay, style: TextStyle(color: AppConstants.grey, fontSize: 20, fontFamily: "Bell Gothic Light"), textDirection: TextDirection.rtl, textAlign: TextAlign.right),
                    onPressed: () {
            ...
            ? Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                recordList.length > 0
                    ? GFButton(
                        ...
                        textColor: AppConstants.grey,
                        child: Text(playButtonTextRec, style: TextStyle(color: AppConstants.grey, fontSize: 20, fontFamily: "Bell Gothic Light"), textDirection: TextDirection.rtl, textAlign: TextAlign.right),
                        onPressed: () {
